...
public class ECC_Curve_Ed {

    BigInteger p; // field size
    BigInteger a; // a coefficient of the equation (a==1 for Edwards)
    ...
    // Curve ax^2+y^2 = 1 + dx^2 + y^2
    public ECC_Curve_Ed(BigInteger p, BigInteger a, BigInteger d, BigInteger x, BigInteger y, BigInteger n, BigInteger h){
        this.p = p;
        this.a = a;
        this.d = d;
        this.x = x;
