...
public class ECC_Curve_Weierstrass {
    ...
    public ECC_Curve_Weierstrass(BigInteger p, BigInteger a, BigInteger b, BigInteger x, BigInteger y, BigInteger n, BigInteger h){
        this.p = p;
        this.a = a;
        this.b = b;
