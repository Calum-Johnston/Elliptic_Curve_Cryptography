...
import ecc.Points.Weierstrass.ECC_Point_W_Jacob_a;
...
public class W_Jacob_a_Tests {
    ...
    public void setupThis() {
        ...
        basePoint = new ECC_Point_W_Jacob_a(curve, curve.getX(), curve.getY(), BigInteger.ONE);
    ...
    public void testProjective_DA() {
        ...
        ECC_Point_W_Jacob_a p1_ = ((ECC_Point_W_Jacob_a) p1).convertAffine();
        ECC_Point_W_Jacob_a p2_ = ((ECC_Point_W_Jacob_a) p2).convertAffine();
