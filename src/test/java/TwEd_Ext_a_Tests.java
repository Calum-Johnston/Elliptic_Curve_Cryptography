...
import ecc.Points.Edwards.ECC_Point_Ed_Proj;
import ecc.Points.Edwards.ECC_Point_TwEd_Ext;
import ecc.Points.Edwards.ECC_Point_TwEd_Ext_a;
...
public class TwEd_Ext_a_Tests {
    ...
    public void setupThis() {
        curve = Curves.TwEd25519();
        basePoint = new ECC_Point_TwEd_Ext_a(curve, curve.getX(), curve.getY(), BigInteger.ONE, curve.getX().multiply(curve.getY()).mod(curve.getP()));
    ...
    public void testProjective_DA() {
        ...
        ECC_Point_TwEd_Ext_a p1_ = ((ECC_Point_TwEd_Ext_a) p1).convertAffine();
        ECC_Point_TwEd_Ext_a p2_ = ((ECC_Point_TwEd_Ext_a) p2).convertAffine();
