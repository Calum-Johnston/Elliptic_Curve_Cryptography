...
public class TwEd_Proj_Tests {
    ...
    public void setupThis() {
        ...
        basePoint = new ECC_Point_TwEd_Proj(curve, curve.getX(), curve.getY(), BigInteger.ONE);
    ...
    public void testProjective_DA() {
        ...
        ECC_Point_TwEd_Proj p1_ = ((ECC_Point_TwEd_Proj) p1).convertAffine();
        ECC_Point_TwEd_Proj p2_ = ((ECC_Point_TwEd_Proj) p2).convertAffine();
