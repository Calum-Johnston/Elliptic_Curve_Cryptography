...
import ecc.Points.Edwards.ECC_Point_TwEd_Inv;
import ecc.Points.Edwards.ECC_Point_TwEd_Inv;
...
public class TwEd_Inv_Tests {
    ...
    public void setupThis() {
        ...
        basePoint = new ECC_Point_TwEd_Inv(curve, curve.getY(), curve.getX(), curve.getX().multiply(curve.getY().mod(curve.getP())));
    ...
    public void test_DoubleandAdd() {
        ...
        ECC_Point_TwEd_Inv p1_ = ((ECC_Point_TwEd_Inv) p1).convertAffine();
        ECC_Point_TwEd_Inv p2_ = ((ECC_Point_TwEd_Inv) p2).convertAffine();
