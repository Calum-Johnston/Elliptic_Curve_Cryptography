...
public class TwEd_Ext_Tests {
    ...
    public void setupThis() {
        ...
        basePoint = new ECC_Point_TwEd_Ext(curve, curve.getX(), curve.getY(), BigInteger.ONE, curve.getX().multiply(curve.getY()).mod(curve.getP()));
    ...
    public void test_DoubleandAdd() {
        ...
        ECC_Point_TwEd_Ext p1_ = ((ECC_Point_TwEd_Ext) p1).convertAffine();
        ECC_Point_TwEd_Ext p2_ = ((ECC_Point_TwEd_Ext) p2).convertAffine();
